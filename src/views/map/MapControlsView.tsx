 ...
 * @description View hiển thị thanh công cụ tương tác bản đồ (Map Interaction Controls View Component).
 * 
 * Chức năng chính: Thanh Công cụ Tương tác Bản đồ (Map Control & Measurement View)
 * Các chức năng nhỏ:
 * - Điều khiển Zoom In / Zoom Out và chuyển nhanh về vị trí toàn cảnh Nam Trung Bộ & Tây Nguyên.
 * - Chế độ di chuyển bản đồ (Pan Mode).
 * - Công cụ đo chiều dài đường/sông (Length Measurement Tool).
 * - Công cụ đo diện tích vùng ngập (Area Measurement Tool).
 */
...
const MapControlsView: React.FC = () => {
  ...
  // Cập nhật mức zoom hiện tại và giới hạn zoom khi map thay đổi
  useEffect(() => {
    if (!map) return;
